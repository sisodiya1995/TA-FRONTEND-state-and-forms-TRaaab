...
//1- Using Function component and Hooks
function Products() {
  ...
  function handlecart(event) {
    ...
    setcart(cart.concat(singleProduct));
  ...
  function handleSize(event) {
    ...
    // console.log(filterProduct ,"fitler");
      ...
      <div className="parent-div">
        ...
        <div className="buttons">
          {["S", "XS", "M", "XL", "X", "L", "XXL"].map((size) => {
            return (
              <button
                className={isActive === size ? "btn black" : "btn"}
                onClick={handleSize}
              >
                {size}
              </button>
        ...
        <p className="lenth">{allProduct.length} of found products</p>
